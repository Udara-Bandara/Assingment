 ...
 * @author ubandara
 */
public class remove_SB_ug_user extends javax.swing.JFrame {

    /**
     * Creates new form removeUser
     */
    public remove_SB_ug_user() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getCname.setText("eg:- 2018ucs001");
    ...
    private void cancleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancleActionPerformed
        ...
        undergraduate_SB_student_details c = new undergraduate_SB_student_details();
        c.setVisible(true);
    ...
    private void removeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeActionPerformed
        try {
            ...
            db.deleteStudent("undergraduate_Student",id );
             
            comfirmRemove.setVisible(true);
        } catch (SQLException ex) {
            Logger.getLogger(remove_SB_ug_user.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void getCnameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_getCnameFocusGained
        if(getCname.getText().equals("eg:- 2018ucs001")){
            getCname.setText("");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(remove_SB_ug_user.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new remove_SB_ug_user().setVisible(true);
            }
        });
    }
