 ...
 * @author ubandara
 */
public class remove_SB_ug_subject extends javax.swing.JFrame {

    /**
     * Creates new form removeUser
     */
    public remove_SB_ug_subject() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "REMOVING SUBJECT", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lato", 0, 20))); // NOI18N
        ...
        getCname1.setText("subject name");
    ...
    private void cancleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancleActionPerformed
        // REMOVING CANCLE
       this.dispose();
       undergraduate_SB_subject_details c = new undergraduate_SB_subject_details();
       c.setVisible(true);
    ...
    private void getCnameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_getCnameFocusGained
        if(getCname.getText().equals("eg:- US001")){
           getCname.setText("");
        } 
    ...
    private void getCname1FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_getCname1FocusGained
        if(getCname1.getText().equals("subject name")){
           getCname1.setText("");
        } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(remove_SB_ug_subject.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new remove_SB_ug_subject().setVisible(true);
            }
        });
    }
