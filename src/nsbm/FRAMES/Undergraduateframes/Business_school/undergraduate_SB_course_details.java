 ...
 * @author ubandara
 */
public class undergraduate_SB_course_details extends javax.swing.JFrame {

    /**
     * Creates new form Lecture_details
     */
    public undergraduate_SB_course_details() {
        initComponents();
        DBoperation db = new DBoperation();
        try {
            UG_course.setModel(buildTable.buildTableModel(db.viewUGcourse("nsbm02")));
        } catch (SQLException ex) {
            Logger.getLogger(undergraduate_SB_course_details.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void newCourseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newCourseActionPerformed
        //NEW instructor
        undergraduate_SB_course c = new undergraduate_SB_course();
        c.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(undergraduate_SB_course_details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new undergraduate_SB_course_details().setVisible(true);
            }
        });
    }
