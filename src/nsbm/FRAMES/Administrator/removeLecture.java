...
public class removeLecture extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("remove_lecture");
        setLocation(new java.awt.Point(450, 200));
        setMinimumSize(new java.awt.Dimension(1100, 700));
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "REMOVING Lecture", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lato", 0, 20))); // NOI18N

        nName.setFont(new java.awt.Font("Liberation Sans", 1, 20)); // NOI18N
        nName.setText("Lecture Name");

        nName1.setFont(new java.awt.Font("Liberation Sans", 1, 20)); // NOI18N
        nName1.setText("Lecture Id");
    ...
    private void cancleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancleActionPerformed
        // removing cancle
        Lecture_details c = new Lecture_details();
        c.setVisible(true);
        this.dispose();
    ...
    private void getCnameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_getCnameFocusGained
        if(getCname.getText().equals("eg:- Lec001")){
            getCname.setText("");
        }
