 ...
 * @author ubandara
 */
public class removeAdminUser extends javax.swing.JFrame {

    /**
     * Creates new form removeUser
     */
    public removeAdminUser() {
        initComponents();
    }
    ...
    private void cancleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancleActionPerformed
        try {
            // removing cancle
            this.dispose();
            Faculty_admin_details c = new Faculty_admin_details();
            c.setVisible(true);
        } catch (SQLException ex) {
            Logger.getLogger(removeAdminUser.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void getCnameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_getCnameFocusGained
        if(getCname.getText().equals("eg:- Acs01")){
            getCname.setText("");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(removeAdminUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new removeAdminUser().setVisible(true);
            }
        });
    }
