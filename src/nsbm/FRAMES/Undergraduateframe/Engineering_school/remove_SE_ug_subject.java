 ...
 * @author ubandara
 */
public class remove_SE_ug_subject extends javax.swing.JFrame {

    /**
     * Creates new form removeUser
     */
    public remove_SE_ug_subject() {
        initComponents();
    }
    ...
    private void cancleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancleActionPerformed
        // REMOVING CANCLE
       this.dispose();
       undergraduate_SE_subject_details c = new undergraduate_SE_subject_details();
       c.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(remove_SE_ug_subject.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new remove_SE_ug_subject().setVisible(true);
            }
        });
    }
