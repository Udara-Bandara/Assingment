 ...
 * @author ubandara
 */
public class undergraduate_SE_subject extends javax.swing.JFrame {

    DBoperation db = new DBoperation();
    
    public undergraduate_SE_subject() {
        initComponents();
    }
    ...
    private void tobackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tobackActionPerformed
        // go back
        undergraduate_SE_subject_details u = new undergraduate_SE_subject_details();
        u.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(undergraduate_SE_subject.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new undergraduate_SE_subject().setVisible(true);
            }
        });
    }
