 ...
 * @author ubandara
 */
public class undergraduate_SE_subject_details extends javax.swing.JFrame {

    /**
     * Creates new form Lecture_details
     */
    public undergraduate_SE_subject_details() {
        initComponents();
        DBoperation db = new DBoperation();
        try {
            UG_subject.setModel(buildTable.buildTableModel(db.viewUGsubject("nsbm03")));
        } catch (SQLException ex) {
            Logger.getLogger(undergraduate_SE_subject_details.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void newsubjectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newsubjectActionPerformed
        //NEW subject
        undergraduate_SE_subject s = new undergraduate_SE_subject();
        s.setVisible(true);
        this.dispose();
    ...
    private void delSubjectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delSubjectActionPerformed
        // remove subject
        remove_SE_ug_subject r = new remove_SE_ug_subject();
        r.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(undergraduate_SE_subject_details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new undergraduate_SE_subject_details().setVisible(true);
            }
        });
    }
