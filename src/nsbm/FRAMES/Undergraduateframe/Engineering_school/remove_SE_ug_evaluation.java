 ...
 * @author ubandara
 */
public class remove_SE_ug_evaluation extends javax.swing.JFrame {

    /**
     * Creates new form removeUser
     */
    public remove_SE_ug_evaluation() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "REMOVING SUBJECT", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lato", 0, 18))); // NOI18N
        ...
        setTitle("remove_evaluation\n");
        setLocation(new java.awt.Point(450, 200));
        setMinimumSize(new java.awt.Dimension(1100, 700));
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "REMOVING EVALUATION", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lato", 0, 20))); // NOI18N
        ...
        nName1.setText("Evalution Id");

        getCname1.setFont(new java.awt.Font("Lato", 0, 16)); // NOI18N
        getCname1.setText("evaluation name");
    ...
    private void removeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeActionPerformed
        try {
            ...
            db.deleteStudent("Evaluation_detail",id );
             
            comfirmRemove.setVisible(true);
        } catch (SQLException ex) {
            Logger.getLogger(remove_SE_ug_evaluation.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void getCnameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_getCnameFocusGained
        if(getCname.getText().equals("eg:- ACS001")){
           getCname.setText("");
        } 
    ...
    private void getCname1FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_getCname1FocusGained
        if(getCname1.getText().equals("evaluation name")){
           getCname1.setText("");
        } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(remove_SE_ug_evaluation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new remove_SE_ug_evaluation().setVisible(true);
            }
        });
    }
