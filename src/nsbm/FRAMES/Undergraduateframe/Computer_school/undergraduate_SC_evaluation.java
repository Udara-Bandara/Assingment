 ...
 * @author ubandara
 */
public class undergraduate_SC_evaluation extends javax.swing.JFrame {

    DBoperation db = new DBoperation();
    
    public undergraduate_SC_evaluation() {
        initComponents();
    }
    ...
    private void tobackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tobackActionPerformed
        // go back
        undergraduate_SC_evaluation_details u = new undergraduate_SC_evaluation_details();
        u.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(undergraduate_SC_evaluation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new undergraduate_SC_evaluation().setVisible(true);
            }
        });
    }
