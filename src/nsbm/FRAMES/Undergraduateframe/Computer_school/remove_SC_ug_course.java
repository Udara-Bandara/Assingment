 ...
 * @author ubandara
 */
public class remove_SC_ug_course extends javax.swing.JFrame {

    /**
     * Creates new form removeUser
     */
    public remove_SC_ug_course() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(remove_SC_ug_course.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new remove_SC_ug_course().setVisible(true);
            }
        });
    }
