 ...
 * @author ubandara
 */
public class undergraduate_SC_student_details extends javax.swing.JFrame {

    /**
     * Creates new form Lecture_details
     */
    public undergraduate_SC_student_details() {
        initComponents();
        DBoperation db = new DBoperation();
        
        try {
           
           UG_table.setModel(buildTable.buildTableModel(db.viewUGstudent("nsbm01")));
    ...
    private void newStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newStudentActionPerformed
        //NEW Student
        undergraduate_SC_student u = new undergraduate_SC_student();
        u.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(undergraduate_SC_student_details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new undergraduate_SC_student_details().setVisible(true);
            }
        });
    }
