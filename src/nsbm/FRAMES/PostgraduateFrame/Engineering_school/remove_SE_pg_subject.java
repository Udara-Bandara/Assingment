 ...
 * @author ubandara
 */
public class remove_SE_pg_subject extends javax.swing.JFrame {

    /**
     * Creates new form removeUser
     */
    public remove_SE_pg_subject() {
        initComponents();
    }
    ...
    private void cancleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancleActionPerformed
        // REMOVING CANCLE
        postgraduate_SE_subject_details c = new postgraduate_SE_subject_details();
        c.setVisible(true);
       this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(remove_SE_pg_subject.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new remove_SE_pg_subject().setVisible(true);
            }
        });
    }
