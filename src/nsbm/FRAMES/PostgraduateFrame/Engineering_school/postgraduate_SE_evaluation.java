 ...
 * @author ubandara
 */
public class postgraduate_SE_evaluation extends javax.swing.JFrame {

    DBoperation db = new DBoperation();
    
    public postgraduate_SE_evaluation() {
        initComponents();
    }
    ...
    private void tobackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tobackActionPerformed
        // go back
        postgraduate_SE_evaluation_details u = new postgraduate_SE_evaluation_details();
        u.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(postgraduate_SE_evaluation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new postgraduate_SE_evaluation().setVisible(true);
            }
        });
    }
