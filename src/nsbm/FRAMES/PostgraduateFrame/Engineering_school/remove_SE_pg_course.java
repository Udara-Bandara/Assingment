 ...
 * @author ubandara
 */
public class remove_SE_pg_course extends javax.swing.JFrame {

    /**
     * Creates new form removeUser
     */
    public remove_SE_pg_course() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(remove_SE_pg_course.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new remove_SE_pg_course().setVisible(true);
            }
        });
    }
