 ...
 * @author ubandara
 */
public class remove_SE_pg_user extends javax.swing.JFrame {

    /**
     * Creates new form removeUser
     */
    public remove_SE_pg_user() {
        initComponents();
    }
    ...
    private void cancleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancleActionPerformed
        // removing cancle
        postgraduate_SE_student_details c = new postgraduate_SE_student_details();
        c.setVisible(true);
        this.dispose();
    ...
    private void removeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeActionPerformed
       ...
       try {
            ...
            Logger.getLogger(remove_SE_pg_user.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(remove_SE_pg_user.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new remove_SE_pg_user().setVisible(true);
            }
        });
    }
