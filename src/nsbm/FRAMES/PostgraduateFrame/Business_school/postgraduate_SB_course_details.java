 ...
 * @author ubandara
 */
public class postgraduate_SB_course_details extends javax.swing.JFrame {

    /**
     * Creates new form Lecture_details
     */
    public postgraduate_SB_course_details() {
        initComponents();
        
        DBoperation db = new DBoperation();
        try {
            PGcourseTable.setModel(buildTable.buildTableModel(db.viewPGcourse("nsbm02")));
        } catch (SQLException ex) {
            Logger.getLogger(postgraduate_SB_course_details.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void newCourseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newCourseActionPerformed
        //NEW instructor
        postgraduate_SB_course c = new postgraduate_SB_course();
        c.setVisible(true);
        this.dispose();
    ...
    private void delCourseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delCourseActionPerformed
        // remove instructor
        remove_SB_pg_course r = new remove_SB_pg_course();
        r.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(postgraduate_SB_course_details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new postgraduate_SB_course_details().setVisible(true);
            }
        });
    }
