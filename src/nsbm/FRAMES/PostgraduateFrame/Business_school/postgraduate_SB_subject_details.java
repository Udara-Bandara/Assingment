 ...
 * @author ubandara
 */
public class postgraduate_SB_subject_details extends javax.swing.JFrame {

    /**
     * Creates new form Lecture_details
     */
    public postgraduate_SB_subject_details() {
        initComponents();
        DBoperation db = new DBoperation();
        try {
            PGsubject.setModel(buildTable.buildTableModel(db.viewPGsubject("nsbm02")));
        } catch (SQLException ex) {
            Logger.getLogger(postgraduate_SB_subject_details.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void newsubjectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newsubjectActionPerformed
        //NEW subject
        postgraduate_SB_subject sub = new postgraduate_SB_subject();
        sub.setVisible(true);
        this.dispose();
    ...
    private void delSubjectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delSubjectActionPerformed
        // remove subject
        remove_SB_pg_subject r = new remove_SB_pg_subject();
        r.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(postgraduate_SB_subject_details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new postgraduate_SB_subject_details().setVisible(true);
            }
        });
    }
