 ...
 * @author ubandara
 */
public class postgraduate_SB_evaluation extends javax.swing.JFrame {

    DBoperation db = new DBoperation();
    
    public postgraduate_SB_evaluation() {
        initComponents();
    }
    ...
    private void tobackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tobackActionPerformed
        // go back
        postgraduate_SB_evaluation_details u = new postgraduate_SB_evaluation_details();
        u.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(postgraduate_SB_evaluation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new postgraduate_SB_evaluation().setVisible(true);
            }
        });
    }
