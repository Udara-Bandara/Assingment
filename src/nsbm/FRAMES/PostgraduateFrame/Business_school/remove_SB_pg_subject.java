 ...
 * @author ubandara
 */
public class remove_SB_pg_subject extends javax.swing.JFrame {

    /**
     * Creates new form removeUser
     */
    public remove_SB_pg_subject() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(remove_SB_pg_subject.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new remove_SB_pg_subject().setVisible(true);
            }
        });
    }
