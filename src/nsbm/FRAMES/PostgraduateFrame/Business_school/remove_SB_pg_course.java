 ...
 * @author ubandara
 */
public class remove_SB_pg_course extends javax.swing.JFrame {

    /**
     * Creates new form removeUser
     */
    public remove_SB_pg_course() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getCname1.setText("eg:- Master of Computer Science");
    ...
    private void getCname1FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_getCname1FocusGained
        if(getCname1.getText().equals("eg:- Master of Computer Science")){
            getCname1.setText("");
        }
    ...
    private void getCnameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_getCnameFocusGained
        if(getCname.getText().equals("eg:- Mas001")){
            getCname.setText("");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(remove_SB_pg_course.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new remove_SB_pg_course().setVisible(true);
            }
        });
    }
