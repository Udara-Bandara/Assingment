 ...
 * @author ubandara
 */
public class Computer_pg_login extends javax.swing.JFrame {

    /**
     * Creates new form Login
     */
    public Computer_pg_login() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        evaluation1 = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("postgraduate_details");
        ...
        evaluation1.setBackground(java.awt.Color.darkGray);
        evaluation1.setFont(new java.awt.Font("Lato", 0, 48)); // NOI18N
        evaluation1.setForeground(new java.awt.Color(254, 254, 254));
        evaluation1.setText("EVALUATION");
        evaluation1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                evaluation1ActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(evaluation1, javax.swing.GroupLayout.PREFERRED_SIZE, 806, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(logout, javax.swing.GroupLayout.PREFERRED_SIZE, 806, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(studentReg, javax.swing.GroupLayout.PREFERRED_SIZE, 806, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(evaluation1, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void studentRegActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_studentRegActionPerformed
        ...
        postgraduate_SC_student_details s = new postgraduate_SC_student_details();
        s.setVisible(true);
        this.dispose();
    ...
    private void subjectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_subjectActionPerformed
        // new subject
        postgraduate_SC_subject_details sub = new postgraduate_SC_subject_details();
        sub.setVisible(true);
        this.dispose();
    ...
    private void evaluation1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_evaluation1ActionPerformed
        postgraduate_SC_evaluation_details e =new postgraduate_SC_evaluation_details();
        e.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_evaluation1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Computer_pg_login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Computer_pg_login().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton evaluation1;
