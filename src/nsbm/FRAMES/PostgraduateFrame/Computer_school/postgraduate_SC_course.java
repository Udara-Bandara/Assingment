 ...
 * @author ubandara
 */
public class postgraduate_SC_course extends javax.swing.JFrame {

    DBoperation db = new DBoperation();
    
    public postgraduate_SC_course() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("postgraduate_course_details");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "POSTGRADUATE  COURSE  DETAILS", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lato", 1, 20))); // NOI18N
        ...
        getCName.setText("eg:- Master of Computer Science");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(getCName, javax.swing.GroupLayout.DEFAULT_SIZE, 255, Short.MAX_VALUE)
                            .addComponent(getCId)
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        try{
            ...
            c.setFaculty_id("nsbm01");
        
            db.addPostgraduateCourse(c);
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        //
        postgraduate_SC_course_details c = new postgraduate_SC_course_details();
        c.setVisible(true);
        this.dispose();
        comfirm.dispose();
    ...
    private void tobackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tobackActionPerformed
        // go back
        postgraduate_SC_course_details u = new postgraduate_SC_course_details();
        u.setVisible(true);
        this.dispose();
    ...
    private void getCNameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_getCNameFocusGained
        ...
        if(getCName.getText().equals("eg:- Master of Computer Science")){
            getCName.setText("");
        }
    ...
    private void getCIdFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_getCIdFocusGained
       if(getCId.getText().equals("eg:- Mas001")){
            getCId.setText("");
        } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(postgraduate_SC_course.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new postgraduate_SC_course().setVisible(true);
            }
        });
    }
