 ...
 * @author ubandara
 */
public class postgraduate_SC_subject extends javax.swing.JFrame {

    DBoperation db = new DBoperation();
    
    public postgraduate_SC_subject() {
        initComponents();
    }
    ...
    private void tobackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tobackActionPerformed
        // go back
        postgraduate_SC_subject_details u = new postgraduate_SC_subject_details();
        u.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(postgraduate_SC_subject.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new postgraduate_SC_subject().setVisible(true);
            }
        });
    }
