 ...
 * @author ubandara
 */
public class postgraduate_SC_subject_details extends javax.swing.JFrame {

    /**
     * Creates new form Lecture_details
     */
    public postgraduate_SC_subject_details() {
        initComponents();
        DBoperation db = new DBoperation();
        try {
            PGsubject.setModel(buildTable.buildTableModel(db.viewPGsubject("nsbm01")));
        } catch (SQLException ex) {
            Logger.getLogger(postgraduate_SC_subject_details.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void newsubjectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newsubjectActionPerformed
        //NEW subject
        postgraduate_SC_subject sub = new postgraduate_SC_subject();
        sub.setVisible(true);
        this.dispose();
    ...
    private void delSubjectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delSubjectActionPerformed
        // remove subject
        remove_SC_pg_subject r = new remove_SC_pg_subject();
        r.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(postgraduate_SC_subject_details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new postgraduate_SC_subject_details().setVisible(true);
            }
        });
    }
