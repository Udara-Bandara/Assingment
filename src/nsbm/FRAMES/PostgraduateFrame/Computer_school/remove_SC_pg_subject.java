 ...
 * @author ubandara
 */
public class remove_SC_pg_subject extends javax.swing.JFrame {

    /**
     * Creates new form removeUser
     */
    public remove_SC_pg_subject() {
        initComponents();
    }
    ...
    private void cancleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancleActionPerformed
        // REMOVING CANCLE
        postgraduate_SC_subject_details c = new postgraduate_SC_subject_details();
        c.setVisible(true);
       this.dispose();
    ...
    private void getCnameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_getCnameFocusGained
        if(getCname.getText().equals("eg:- PS001")){
           getCname.setText("");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(remove_SC_pg_subject.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new remove_SC_pg_subject().setVisible(true);
            }
        });
    }
