 ...
 * @author ubandara
 */
public class postgraduate_SC_student_details extends javax.swing.JFrame {

    /**
     * Creates new form Lecture_details
     */
    public postgraduate_SC_student_details() {
        initComponents();
        DBoperation db = new DBoperation();
        try {
            PG_Table.setModel(buildTable.buildTableModel(db.viewPGstudent("nsbm01")));
        } catch (SQLException ex) {
            Logger.getLogger(postgraduate_SC_student_details.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void newStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newStudentActionPerformed
        //NEW student
       postgraduate_SC_student pr = new postgraduate_SC_student();
       pr.setVisible(true);
       this.dispose();
    ...
    private void delStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delStudentActionPerformed
        // remove student
        remove_SC_pg_user r = new remove_SC_pg_user();
        r.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(postgraduate_SC_student_details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new postgraduate_SC_student_details().setVisible(true);
            }
        });
    }
