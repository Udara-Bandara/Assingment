 ...
 * @author ubandara
 */
public class postgraduate_SC_course_details extends javax.swing.JFrame {

    /**
     * Creates new form Lecture_details
     */
    public postgraduate_SC_course_details() {
        initComponents();
        
        DBoperation db = new DBoperation();
        try {
            PGcourseTable.setModel(buildTable.buildTableModel(db.viewPGcourse("nsbm01")));
        } catch (SQLException ex) {
            Logger.getLogger(postgraduate_SC_course_details.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        PGcourseTable = new javax.swing.JTable();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "POSTGRADUATE  COURSE  DETAILS", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lato", 1, 20))); // NOI18N
        ...
        PGcourseTable.setBackground(java.awt.Color.lightGray);
        PGcourseTable.setBorder(null);
        PGcourseTable.setFont(new java.awt.Font("Lato", 0, 20)); // NOI18N
        PGcourseTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        PGcourseTable.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        PGcourseTable.setGridColor(java.awt.Color.white);
        PGcourseTable.setRowHeight(36);
        jScrollPane1.setViewportView(PGcourseTable);
    ...
    private void newCourseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newCourseActionPerformed
        //NEW instructor
        postgraduate_SC_course c = new postgraduate_SC_course();
        c.setVisible(true);
        this.dispose();
    ...
    private void delCourseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delCourseActionPerformed
        // remove instructor
        remove_SC_pg_course r = new remove_SC_pg_course();
        r.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(postgraduate_SC_course_details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new postgraduate_SC_course_details().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTable PGcourseTable;
